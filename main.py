"""Игровой модуль.
Содержит функции выбора класса персонажа, прокачки навыков персонажа,
применения атаки, защиты и специального навыка персонажа.
"""
...
def attack(char_name: str, char_class: str) -> str:
    """Функция атки для разных классов персонажей."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция защиты для разных классов персонажей."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция применения специального навыка для разных классов персонажей."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция тренировки наыков для разных классов персонажей."""
    if char_class == 'warrior':
        print(f'{char_name}, ты Воитель — отличный боец'
              'ближнего боя.')
    if char_class == 'mage':
        print(f'{char_name}, ты Маг — превосходный укротитель'
              'стихий.')
    if char_class == 'healer':
...
def choice_char_class() -> str:
    """Ввод имени и выбор класса персонажа."""
    approve_choice: str = ''
    char_class: str = ''
